...
def _build_checks(root: Path) -> list[CheckResult]:
    return [
        ...
        _check(
            ...
            category="Governance",
            weight=3,
            passed=_has_any(root, ["SUPPORT.md", ".github/SUPPORT.md"]),
            detail="A support policy tells users where to ask questions and where not to report secrets.",
            recommendation="Add SUPPORT.md with issue, discussion, and security contact guidance.",
        ),
        _check(
            root,
            key="maintainers",
            ...
            category="Governance",
            weight=3,
            passed=_has_any(root, ["MAINTAINERS.md", ".github/MAINTAINERS.md", "docs/maintainer-guide.md"]),
            detail="Maintainer guidance makes triage, review, and release work repeatable.",
            recommendation="Add MAINTAINERS.md or docs/maintainer-guide.md with project operating notes.",
        ),
        _check(
            root,
            key="labels",
            title="Issue label taxonomy",
            category="Governance",
            weight=2,
            passed=_has_any(root, [".github/labels.yml", ".github/labels.yaml", ".github/labels.json"]),
            detail="A label taxonomy helps maintainers route issues and contributor work consistently.",
            recommendation="Add .github/labels.yml or document the label taxonomy.",
        ),
        _check(
            root,
            key="issue_templates",
        ...
        _check(
            ...
            detail="A release workflow reduces manual packaging mistakes.",
            recommendation="Add a release or publish workflow for tagged versions.",
        ),
        _check(
            root,
            key="roadmap",
            ...
            category="Onboarding",
            weight=3,
            passed=_has_any(root, ["ROADMAP.md", "docs/roadmap.md"]),
            detail="A roadmap helps contributors choose useful work without asking maintainers first.",
            recommendation="Add ROADMAP.md or docs/roadmap.md with near-term and future priorities.",
        ),
        _check(
            root,
            key="docs",
